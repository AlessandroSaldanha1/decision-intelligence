    ...
    <div className="mx-auto max-w-3xl px-4 py-12 space-y-8">
      ...
      <div className="rounded-xl border border-white/10 bg-gray-900 p-6 space-y-4">
        ...
        <div className="space-y-2 text-sm text-gray-300">
          <p>
            <span className="text-gray-500">Como</span> {MOCK_ARTIFACTS.userStory.asA},
          </p>
          <p>
            <span className="text-gray-500">eu quero</span> {MOCK_ARTIFACTS.userStory.iWant}
          </p>
          <p>
            <span className="text-gray-500">para que</span> {MOCK_ARTIFACTS.userStory.soThat}.
          </p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          { label: 'Cenários BDD', value: MOCK_ARTIFACTS.bddCount, color: 'text-blue-400' },
          {
            ...
            value: MOCK_ARTIFACTS.testCasesCount,
            color: 'text-green-400',
          },
          {
            label: 'Itens na DoD',
            value: Object.values(MOCK_ARTIFACTS.dod).flat().length,
            color: 'text-violet-400',
          },
        ].map((stat) => (
          <div
            key={stat.label}
            className="rounded-xl border border-white/10 bg-gray-900 p-4 text-center"
          >
