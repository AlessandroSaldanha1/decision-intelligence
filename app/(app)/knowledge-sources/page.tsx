...
const SOURCES = [
  {
    id: 'tasks',
    label: 'Tasks e Sprints',
    description: 'Histórico de tasks e sprints concluídas',
    count: 247,
    enabled: true,
  },
  {
    id: 'comments',
    label: 'Comentários',
    description: 'Discussões e decisões registradas em tasks',
    count: 1823,
    enabled: true,
  },
  {
    id: 'subtasks',
    label: 'Subtasks',
    description: 'Detalhamento técnico de implementações',
    count: 0,
    enabled: false,
  },
  {
    ...
    <div className="mx-auto max-w-2xl px-4 py-12 space-y-8">
      <div className="space-y-1">
        ...
        <p className="text-gray-400">
          Selecione as fontes que serão usadas para construir a memória organizacional.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-blue-500/20 bg-blue-600/10 p-4">
        <p className="text-sm text-blue-300">
          <strong>2 fontes ativas</strong> — 2.070 documentos indexados e prontos para busca
          semântica.
        </p>
      </div>
